...
launch_args = [
    ...
    DeclareLaunchArgument('nimbro_api_speech_cache_folder', default_value=os.path.join(get_package_path("nimbro_api"), "cache", "speech"), description='Path to the cache folder. If it does not exist it is automatically created.'),
