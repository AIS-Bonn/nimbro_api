...
from nimbro_utils.lazy import start_and_spin_node, ParameterHandler, Logger, decode_b64, read_as_b64, get_package_path
...
cache_read = True
cache_write = True
cache_folder = os.path.join(get_package_path("nimbro_api"), "cache", "images")
